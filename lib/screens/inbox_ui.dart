...
import 'package:hidden_gems_sg/helper/inbox_controller.dart';
      ...
      child: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: SizedBox(
                      height: 100,
                      width: 100,
                      child: place.getImages().isNotEmpty
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Spacer(flex: 3),
                      textMinorBold(
                          place.getPlaceName(), const Color(0xff22254C), 14),
                      RatingBarIndicator(
          ...
          Container(
              ...
              child: textMinor(
                  'date: ${invitationC.getDate()}', const Color(0xff22254C))),
          Container(
              child: textMinor(
                  'time: ${invitationC.getTime()}', const Color(0xff22254C))),
          Container(
